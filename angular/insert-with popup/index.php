	...
	<div class="row mt80">
		...
		<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 animated fadeInUp">
			<div class="form-group">
				<label for="companyName">Filter By Company</label> 
				...
				<label for="designation">Filter By Des</label> 
			...
			<label>Search: 
			<input ng-model="post.userSelected" ng-change="autocomplete(post.userSelected)" placeholder="Name"></label>
			...
			<div class="table-responsive">
				<table class="table table-bordered table-hover table-striped">
					...
					<tbody>
						<tr ng-hide="post.userSelected" class="ng-scope" data-ng-repeat="user in post.users | orderBy : '-id' | startFrom:currentPage*pageSize | limitTo:pageSize | filter:search:strict" >
						...
						<tr class="ng-scope" data-ng-repeat="autoname in post.autoname | orderBy : '-id' | startFrom:currentPage*pageSize | limitTo:pageSize | filter:search:strict" >
							...
							<td class="ng-binding"><img ng-src="uploads/{{autoname.avatar}}" style="width:60px"/></td>
							...
							<td><span class="links" data-ng-click="editUser(autoname)"> Edit</span> | <span data-ng-click="deleteUser(autoname)" class="links">Delete</span></td>
						</tr>
					</tbody>
				</table>
