  ...
  <body class="ng-scope" data-ng-controller="RegController" ng-app="regModule">
    <div class="container">
      <div class="col-sm-8">
        ...
        <form novalidate name="regForm" class="form-horizontal ng-valid-required ng-dirty ng-invalid ng-invalid-email ng-valid-minlength" ng-submit="submitForm(user)">
          <div class="form-group">
            <label for="name" class="col-sm-2 control-label">Name</label>
            <div class="col-sm-4">
                <input type="text" name="name" id="name" class="form-control ng-touched ng-valid-minlength ng-pristine ng-valid ng-valid-required" ng-model="user.name" data-ng-minlength="3" required="">
          ...
          <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
              <button class="btn btn-success" type="submit" data-loading-text="Saving User..." ng-disabled="regForm.$invalid" disabled="disabled">Save User</button>
